...
@celery.task(bind=True, autoretry_for=(Exception,), retry_kwargs={"max_retries": 3},queue="email_queue", name="app.tasks.send_mail.send_Forget_mail_task")
...
@celery.task(bind=True, autoretry_for=(Exception,), retry_kwargs={"max_retries": 3},queue="email_queue", name="app.tasks.send_mail.send_Adminmail_task")
